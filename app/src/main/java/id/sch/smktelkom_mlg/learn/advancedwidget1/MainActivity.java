...
public class MainActivity extends AppCompatActivity {
    ...
    private void doProses(LinearLayout llMain) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            String umur = etUmur.toString().toString();
